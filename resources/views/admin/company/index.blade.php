...
@section('title','All PAST EXECUTIVE COMMITTEE')
@section('content')
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h2>All All PAST EXECUTIVE COMMITTEE</h2>
                        <a style="float:right" href="{{ route('company.create') }}" class="btn btn-primary square-btn-adjust">Add EXECUTIVE COMMITTEE</a>
                        <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                All All PAST EXECUTIVE COMMITTEE
                            </div>
