  ...
  <div id="invoice" class="effect2">
    ...
    <div id="invoice-mid">
      ...
      <div id="table">
        <table class="table-main">
          ...
          <tr class="list-item total-row" style="margin-top: 50px">
            <th colspan="" class="tableitem-tb-left" style="text-align:left; width: 25%; float:left">Received with thanks from </th>
            <td colspan="" data-label="Grand Total" class="tableitem-right" style="font-weight:normal;  width: 75%;">{{ $money->thanks_from }}</td>
          </tr>
          </tbody>
        </table>
      </div>
      ...
      <div id="table">
        <table class="table-main">
          <tbody>
          <tr class="list-item total-row" style="margin-top: 50px">
            <td class="tableit" style="text-align:left">The Sum of </td>

            <td colspan="4" class="tableit-rgt" style="font-weight:normal;">Tk. {{ number_format("$money->sum_of_tk",2) }} (<?php
        ...
        taka)</td>
          ...
          <tr class="list-item total-row" style="margin-top: 50px">
            <td class="tableit" style="text-align:left">Mode of Payment </td>

            <td class="tableit-rgt" style="font-weight:normal; colspan="1"> ({{ $money->mode_of_payement }})</td>

            <td class="tableit" style="text-align:center;" colspan="0">Dated  </td>

            <td class="tableit-rgt" style="font-weight:normal;" colspan="4"> {{ date('d-m-Y', strtotime($money->dated)) }}</td>
          </tr>

          <tr class="list-item total-row" style="margin-top: 50px">
            <td class="tableit" style="text-align:left">Drawn on </td>

            <td colspan="4" class="tableit-rgt" style="font-weight:normal;"> {{ $money->drawn_on }}</td>
          </tr>

          <tr class="list-item total-row" style="margin-top: 50px">
            <td class="tableit" style="text-align:left">Issued against  </td>

            <td colspan="4" class="tableit-rgt" style="font-weight:normal;"> {{ $money->issue_against }}</td>
          </tr>
    ...
    <div class="main-table-two">
      <div class="tab-left-side">
        <table class="table table-bordered table-total" aria-label="TABLE">
          <tbody role="rowgroup">
          <tr role="row">
            <td>Premium</td>
            <td>BDT</td>
            <td>{{ number_format("$money->Premium",2) }}</td>
          </tr>
          <tr role="row">
            <td>VAT</td>
            <td>BDT</td>
            <td>{{ number_format("$money->vat",2) }}</td>
          </tr>
          @if($money->stamp !='')
          <tr role="row">
            <td>Stamp</td>
            <td>BDT</td>
            <td>{{ number_format("$money->stamp",2) }}</td>
          </tr>
          @endif
          ...
          <tr role="row">
            <th>Total</th>
            <th>BDT</th>
            <th>{{ number_format("$money->sum_of_tk",2) }}</th>
          </tr>
          </tbody>
        </table>
      </div>
    ...
    padding: 0px;
    /* line-height: 1.7em; */
    margin: 4px 0px;">*Note: If have any compalin about insurance, call 16130.</p>
      </div>
    </footer>
