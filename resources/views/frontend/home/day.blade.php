                ...
                <div class="container-custom">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-12">
                          <a target="blank" style="float:right" href="https://dmcalumnitrust.org/page/instruction" class="btn btn-danger text-right font-weight-bold rounded-50 ml-2">Instruction <div class="ripple-container">
                              <div class="ripple-decorator ripple-on ripple-out" style="left: 30.6px; top: -6px; background-color: rgb(255, 255, 255); transform: scale(4.04762);"></div>
                            </div>
                          </a>
                        </div>
                    </div>
                    <form id="contact-form" method="post" action="{{ route('dmc.day') }}" >
                        ...
                        <div class="user_details">
                           ...
                           <div class="input_pox select-box">
                              ...
                              <select name="batch" class="form-control form-control-custom-3" id="firstDropdown" onchange="selectSecondValue()" required>
...
<div class="input_pox text-area">
                                <span style="font-weight: 500;" class="datails">Current Designation & Working Place</span>
                                <div class="form-outline">
                                    <textarea name="currentdesignation" class="form-control" id="textAreaExample3" rows="3" required></textarea>
                                </div>
                            </div>
                            ...
                            <div class="input_pox text-area">
                                ...
                                <div class="form-outline">
                                    <textarea name="address" class="form-control" id="textAreaExample3" rows="3" required></textarea>
                                </div>
                            </div>

                            <div class="input_pox select-box form-group">
                                <label for="sel1">Choose Souvenir T - Shirt Size</label>
                                <select name="size" class="form-control form-control-custom" id="sel1" style="width: 100%;" required>
                                ...
                                <div class="select-box gender_details">
                                    <div class="myDivjkj">
                                        <div class="input_pox input_pox_2">
                                            <span  class="datails" style="font-size:13px;">Enter your DMC alumni trust life member ID no. </span>
                                            <input type="text" placeholder="Enter your DMC life member ID no." name="lifeno">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="input_radio radio-full">
                                <span class="gender_title">Accompanying person</span>
                                <div class="member-all">
                                    <div class="form-check-inline">
                                ...
                                <div class="select-box gender_details">
                                    <div class="myDivjkj">
                                        <div class="pay-box member-all" style="margin-top:15px">
                                            ...
                                            <div class="form-check-inline">
                                                <label class="form-check-label label-customs2">
                                                    <input id="chkPassport-3" type="radio" class="form-check-input free-lab" name="spouse" value="">Only Kids
                                                </label>
                                            </div>
