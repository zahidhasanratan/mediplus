                    ...
                    <div class="all-company">
                        ...
                        <div class="page-detail">
                            <p class="choose-now" data-now="name"> Sort by : name</p><table class="db-table">
                                ...
                                @foreach($ratings as $ratingsearch)
                                <tr class="each-company" data-id="1159">
                                    <td><a href="{{route('rating.details',$ratingsearch->slug)}}">{{$ratingsearch->title}}</a></td>
                                    <td>{{$ratingsearch->sector}}</td>
                                    <td>{{$ratingsearch->industry}}</td>
                                    <td style="width:120px;">{{$ratingsearch->type}}</td>
                                    <td style="width:80px;">{{$ratingsearch->rating}}</td>
                                    <td style="width:110px;">{{$ratingsearch->radingdate}}</td>
                                    <td style="width:90px;">{{$ratingsearch->outlook}}</td>
                                </tr>
                                @endforeach
                                </tbody>
                            </table>
